<div class="account-update">
	...
	<form action="<?php echo $GLOBALS['web_root']; ?>?action=action_user_update" method="post">
			...
			<div>
				<span><br><br><br>Please enter and confirm your current password in order to save your changes. You can also enter and confirm a new password if you would like to change your login credentials. Note: New password must be 8 characters long and contain an uppercase letter, a lowercase letter, and a number.<br><br></span>
				<div>
